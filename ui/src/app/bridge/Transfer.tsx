    ...
    return (
      <>
        <div className="relative flex items-center justify-between">
          ...
          <TokenBalance balance={balances.l1?.lords} symbol="Lords" />
        </div>
      </>
    );
  };
  ...
  const renderTokenInput = () => {
    return (
      <div className="w-full relative">
        ...
        />
        <div className="absolute text-white right-0 top-0 pt-4 pr-4 flex">
          <Image
            width={12}
            height={12}
            src="/icons/lords.svg"
            alt="Ethereum"
            className="text-white fill-white w-6 h-6 mr-3"
          />
        </div>
      </div>
    );
